...
function Products() {
    ...
    return (
        <>
            ...
            <h1 className='absolute ml-36 text-2xl font-normal titel-text'>Fresh recommendations</h1>
            <div className="flex-container mt-9 flex flex-wrap">
                {products.map((obj, index) => (
                    <div onClick={()=>goToProductDetails(obj)} key={index} className='wrapper'>
                        <div className="card max-w-xs mx-2 mb-4">
                            ...
                            <p className="card-des">{obj.productName}</p>
